...
$_lang['setting_wakatime.api_key'] = 'API Key';
$_lang['setting_wakatime.api_key_desc'] = 'Your WakaTime API key. (Do not set system wide)';
$_lang['setting_wakatime.api_key_desc_shr'] = '<a href="https://wakatime.com/api-key" target="_blank">Get key</a>';
...
$_lang['wakatime.success_settings.test_passed'] = '<div style="text-align:center;"><img src="[[+photo]]" width=420 height=420 alt="[[+display_name]]" style="height:auto; max-width: 100%;" /> <br /> Test passed! Found user "<a href="[[+profile_url_escaped]]" target="_blank">[[+display_name]]</a>."</div>';
$_lang['wakatime.err_settings.test_failed'] = 'Test failed.';